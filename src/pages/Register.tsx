...
const Register = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-screen pt-16 bg-gray-100 text-center px-4">
      {/* Giant logo to match Home/Login */}
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <button
                ...
                disabled={!canProceed}
                className={`px-4 py-2 rounded w-1/2 text-white transition ${
                  canProceed ? "bg-gray-800 hover:bg-gray-900" : "bg-gray-400 cursor-not-allowed"
                }`}
